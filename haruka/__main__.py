...
I'm group manager bot and Anti-spam for Vicky Players🃏

Activate Anti-spam protection in your BM by this command : 
/antispam on 

Made from the source code of [Vicky 🇮🇩](t.me/xuxent)

Special thanks to [this person](t.me/xuxent) for helping me.

Deploy a bot like me [now](www.github.com/VickyMIPA/GroupManager)
...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="🛠 Pelaporan", callback_data="cntrl_panel_M"), 
